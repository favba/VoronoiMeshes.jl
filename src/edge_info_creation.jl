...
compute_edge_longitude(edges::Edges{false}) = compute_longitude_periodic(edges.position)

compute_edge_longitude!(output,edges::Edges{true}) = compute_longitude!(output, edges.position)
compute_edge_longitude(edges::Edges{true}) = compute_longitude_spherical(edges.position)

compute_edge_latitude!(output,edges::Edges{false}) = fill!(output, zero(float_type(edges)))
compute_edge_latitude(edges::Edges{false}) = compute_latitude_periodic(edges.position)

compute_edge_latitude!(output,edges::Edges{true}) = compute_latitude!(output, edges.position)
compute_edge_latitude(edges::Edges{true}) = compute_latitude_spherical(edges.position)
