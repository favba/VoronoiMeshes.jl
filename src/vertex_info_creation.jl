...
compute_vertex_area(vertices::Vertices{false}) = compute_polygon_area_periodic(vertices.info.diagram.generators, vertices.cells,vertices.x_period, vertices.y_period)
...
compute_vertex_area(vertices::Vertices{true}) = compute_polygon_area_spherical(vertices.info.diagram.generators, vertices.cells, vertices.sphere_radius)
...
compute_vertex_centroid(vertices::Vertices{false}) = compute_polygon_centroid_periodic(vertices.info.diagram.generators, vertices.cells,vertices.x_period, vertices.y_period)
...
compute_vertex_centroid(vertices::Vertices{true}) = compute_polygon_centroid_spherical(vertices.info.diagram.generators, vertices.cells, vertices.sphere_radius)

compute_vertex_longitude!(output,vertices::Vertices{false}) = fill!(output, zero(float_type(vertices)))
compute_vertex_longitude(vertices::Vertices{false}) = compute_longitude_periodic(vertices.position)

compute_vertex_longitude!(output,vertices::Vertices{true}) = compute_longitude!(output, vertices.position)
compute_vertex_longitude(vertices::Vertices{true}) = compute_longitude_spherical(vertices.position)

compute_vertex_latitude!(output,vertices::Vertices{false}) = fill!(output, zero(float_type(vertices)))
compute_vertex_latitude(vertices::Vertices{false}) = compute_latitude_periodic(vertices.position)

compute_vertex_latitude!(output,vertices::Vertices{true}) = compute_latitude!(output, vertices.position)
compute_vertex_latitude(vertices::Vertices{true}) = compute_latitude_spherical(vertices.position)
...
compute_vertex_kiteAreas!(output,vertices::Vertices{false}) = compute_kite_areas_periodic!(output, vertices.info.diagram.generators, vertices.position,
                                                                                           vertices.cells, vertices.x_period, vertices.y_period)
compute_vertex_kiteAreas!(output,vertices::Vertices{true}) = compute_kite_areas_spherical!(output, vertices.info.diagram.generators, vertices.position,
